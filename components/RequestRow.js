...
class RequestRow extends Component {
    ...
    render() {
        const FinalizeReady= this.props.request.approvalCount > (this.props.approversCount/2);
        return (
        <Table.Row disabled={this.props.request.complete} positive= {FinalizeReady && !this.props.request.complete}>
